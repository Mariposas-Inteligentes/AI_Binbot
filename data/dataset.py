...
# Creates an index from paths to the images
# Saves the paths and indexes and gets image batches
class ImageFolderDataset(Dataset):
    def __init__(self, root_dir: str, transform=None):
        ...
        # Parses through a directory and obtains the labels and required stuff
