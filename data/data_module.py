...
# Includes a wrapper for an NN module with useful stuff
...
# Distribution for training and testing, train_test_split helps us make this, given a dataset and labels
# divides the data to confirm it to be representative (random)
class DataSplitter:
    @staticmethod
    def split_data(
...
# Wrapper for LightiningDataModule to send quickly stuff
...
class TrashDataModule(ImagesDataModule):
    def __init__(
        self,
        root_dir: str,
        batch_size: int,
